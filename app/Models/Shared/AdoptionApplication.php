...
class AdoptionApplication extends Model
{
    ...
    protected $fillable = [
        'adopter_id', 'pet_id', 'shelter_id', 'rescuer_id', 'reason_for_adoption', 'living_arrangement', 'experience_with_pets', 'household_members', 'allergies', 'has_other_pets', 'other_pets_details', 'can_provide_vet_care', 'status', 'rejection_reason', 'submitted_at', 'reviewed_at'
    ];
