...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
        <h2 class="text-2xl font-bold mb-6">Rescuer Verification</h2>
        ...
        @if(!$verification || $verification->status === 'rejected')
            <form action="{{ route('rescuer.verification.submit') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input type="url" name="facebook_link" id="facebook_link" class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="https://facebook.com/your-page">
                    </div>
                    @error('facebook_link')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
