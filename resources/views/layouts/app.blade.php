...
<html lang="en">
    ...
    <head>
        ...
        <title>@yield('title'), {{ $site_name ?? 'PawMatch' }} - Find Your Perfect Pet Companion</title>
        ...
        @section('navbar')
            ...
            <nav class="navbar">
                <div class="nav-content">
                    ...
                    <div class="nav-links" id="navLinks">
                        ...
                        <a href="{{ route('public.pet-listings') }}"
                            class="nav-link{{ request()->routeIs('public.pet-listings') ? ' active' : '' }}">Find Pets</a>
                        <a href="{{ route('faq') }}"
                            class="nav-link{{ request()->routeIs('faq') ? ' active' : '' }}">FAQ</a>
                        <a href="{{ route('terms') }}"
                            class="nav-link{{ request()->routeIs('terms') ? ' active' : '' }}">Terms</a>
                        @auth
                            <a href="{{ route('dashboard.redirect') }}" class="btn btn-primary">Dashboard</a>
                        @else
                            <a href="{{ route('login') }}"
                                class="btn btn-primary{{ request()->routeIs('login') ? ' active' : '' }}">Login</a>
                        @endauth
                    </div>
                </div>
            </nav>
            ...
            <aside id="mobileNav" class="mobile-nav">
                ...
                <nav class="mobile-nav-links">
                    ...
                    <a href="{{ route('public.pet-listings') }}"
                        class="mobile-nav-link{{ request()->routeIs('public.pet-listings') ? ' active' : '' }}">
                    ...
                    <a href="{{ route('terms') }}"
                        class="mobile-nav-link{{ request()->routeIs('terms') ? ' active' : '' }}">
