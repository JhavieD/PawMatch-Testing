...
<main class="main-content">
    ...
    <div class="content-wrapper">
        <!-- Top Bar -->
        <div class="top-bar" style="margin-top: 2rem; display: flex; align-items: center; justify-content: space-between; background: #fff; border-radius: 16px; box-shadow: 0 2px 12px rgba(74,144,226,0.07); padding: 1.2rem 2.5rem 1.2rem 2.5rem; min-height: 64px;">
