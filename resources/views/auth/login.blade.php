        ...
        <div class="auth-container">
                    ...
                    <div class="auth-header">
                        <div class="auth-icon">
                            <img src="{{ asset('images/logo.png') }}" alt="PawMatch Logo"
                                style="height: 60px; width: auto; display: block; margin: 0 auto; background: #fff; box-shadow: 0 2px 8px rgba(74,144,226,0.08);">
                        </div>
                        <h1>Welcome Back</h1>
                    ...
                    <div class="login-container">
                        ...
                        <div id="loginChoice" class="login-choice compact-choice">
                            <div class="flex flex-col gap-2 mb-2">
                                <a href="{{ route('google.login') }}"
                                    ...
                                    <span class="inline-block align-middle">
                                        <svg width="22" height="22" viewBox="0 0 48 48">
                                            <g>
                                                <path fill="#4285F4"
                                                    d="M24 9.5c3.54 0 6.7 1.22 9.19 3.22l6.85-6.85C35.63 2.36 30.18 0 24 0 14.82 0 6.73 5.82 2.69 14.09l7.98 6.2C12.13 13.13 17.57 9.5 24 9.5z" />
                                                <path fill="#34A853"
                                                ...
                                                <path fill="#EA4335"
                                                    d="M24 44c6.18 0 11.36-2.05 15.18-5.59l-7.19-5.6c-2.01 1.35-4.59 2.16-7.99 2.16-6.43 0-11.87-3.63-13.33-8.79l-7.98 6.2C6.73 42.18 14.82 48 24 48z" />
                                ...
                                <div class="choice-divider my-2 flex items-center justify-center w-full">
                        ...
                        <form id="loginForm" action="{{ route('login') }}" method="POST" class="login-form auth-form">
                            @csrf
                            <button type="button" onclick="showChoiceForm()"
            ...
            <div class="welcome-section">
                <div class="welcome-content">
                    ...
                    <p>Join thousands of pet lovers who have found their forever friends through PawMatch. Start your
                        adoption journey today.</p>
